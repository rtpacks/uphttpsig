...
from uphttpsig.sign import HeaderSigner, Signer
from uphttpsig.tests.keys import RSA_PRIVATE_KEY, RSA_PUBLIC_KEY
from uphttpsig.verify import HeaderVerifier, Verifier
...
class TestVerifyRSASHA1(TestVerifyHMACSHA1):
    ...
    def setUp(self):
        ...
        self.sign_secret = RSA_PRIVATE_KEY
        self.verify_secret = RSA_PUBLIC_KEY
